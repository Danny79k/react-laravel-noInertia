...
<head>
    ...
    @viteReactRefresh
    <!-- vamos a anadir la directiva para refrescar el redenrizado de los compoenntes de vite-->
    @vite('resources/js/react/Main.jsx') <!-- anadimos el entrypoint para los componentes de react -->
...
<body>
    <div id="app"></div> <!-- este va a ser el div "root" para el renderizado de los componentes de react -->
</body>
